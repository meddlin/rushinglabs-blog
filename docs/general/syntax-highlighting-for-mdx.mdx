...
section: 'general'
preview: |-
    This is how someone got this working with MDXProvider 
---
...
This is how someone got this working in Gatsby with MDXProvider and `prism-react-renderer`. 
I used a similar idea to pull things together with Next.js and `react-syntax-highlighter`.
