...
_Note: is it possible to get measurable metrics showing difference in loading times 
between big PNGs and WebPs?_
...
_Demonstrate what the performance gains are._
